    ...
    <section className="relative isolate overflow-hidden bg-[var(--ink)] px-4 py-16 text-[var(--ivory)] sm:px-8 sm:py-20 lg:py-32">
      ...
      <div className="relative z-10 mx-auto grid min-w-0 max-w-7xl gap-9 sm:gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
        ...
        <div>
          ...
          <h2 className="font-serif text-4xl leading-[0.94] tracking-normal sm:text-6xl lg:text-7xl">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2">
            {authorityPoints.map((point, index) => {
              ...
              return (
                <div
                  key={point.label}
                  className="gradient-border rounded-[1.25rem] bg-white/[0.07] p-5 shadow-[0_24px_80px_rgba(0,0,0,0.18)] backdrop-blur-xl sm:rounded-[1.5rem]"
                >
